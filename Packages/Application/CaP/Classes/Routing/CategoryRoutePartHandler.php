 ...
 * @origin: RM
 */
class CategoryRoutePartHandler extends \F3\FLOW3\MVC\Web\Routing\DynamicRoutePart {
	...
	protected function matchValue($value) {
		$category = $this->categoryRepository->findByUuid($value);
		if ($category === NULL) {
			return FALSE;
		}
	...
	protected function resolveValue($value) {
		if (!$value instanceof \F3\Cap\Domain\Model\Category) {
			return FALSE;
		}
